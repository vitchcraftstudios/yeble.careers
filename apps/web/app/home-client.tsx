        ...
        <ScrollReveal delay={190}>
          <section className="rounded-[2rem] border border-[#e3decf] bg-white/95 p-6 shadow-sm sm:p-8">
            <div className="max-w-4xl">
              <p className="text-[11px] uppercase tracking-[0.24em] text-[#2d6a3e]">Who we are for</p>
              <h2 className="mt-2 text-2xl font-semibold text-[#123622] sm:text-3xl">Clear location and service context for employers, candidates, and search systems</h2>
              <p className="mt-3 text-sm leading-7 text-[#31513c] sm:text-base">
                Yeble Careers is a Dehradun-based recruitment and placement agency serving employers and job seekers across Uttarakhand, Uttar Pradesh, Haryana, Himachal Pradesh, Noida, Gurugram, Chandigarh, and nearby North India hiring corridors. We support permanent recruitment, contract staffing, campus hiring, and practical shortlist coordination for companies that need dependable hiring movement and candidates looking for credible opportunities.
              </p>
            </div>
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              <article className="rounded-2xl border border-[#e3decf] bg-[#fffdf6] p-4">
                <h3 className="text-base font-semibold text-[#123622]">For employers</h3>
                <p className="mt-2 text-sm leading-7 text-[#31513c]">Share mandates for recruitment, staffing, or intake support across regional and growth markets in North India.</p>
              </article>
              <article className="rounded-2xl border border-[#e3decf] bg-[#fffdf6] p-4">
                <h3 className="text-base font-semibold text-[#123622]">For job seekers</h3>
                <p className="mt-2 text-sm leading-7 text-[#31513c]">Explore open roles, registration support, and interview coordination for opportunities that fit your location and experience.</p>
              </article>
              <article className="rounded-2xl border border-[#e3decf] bg-[#fffdf6] p-4">
                <h3 className="text-base font-semibold text-[#123622]">For AI and search</h3>
                <p className="mt-2 text-sm leading-7 text-[#31513c]">The site is structured around a clear entity: Yeble Careers, a recruitment agency in Dehradun focused on North India hiring, placement, and staffing support.</p>
              </article>
            </div>
          </section>
        </ScrollReveal>
