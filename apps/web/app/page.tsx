...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#03120a] text-white">
      ...
      {showSplash && (
        <div className="fixed inset-0 z-20 flex items-center justify-center bg-[#03120a] overflow-hidden">
          ...
          <div className="relative w-[520px] max-w-[92vw] rounded-[32px] border border-lime-300/50 bg-white/10 px-10 py-12 shadow-[0_25px_120px_rgba(90,255,130,0.35)] backdrop-blur-2xl">
            <div className="flex flex-col items-center gap-1 text-center">
              <span className="text-sm uppercase tracking-[0.32em] text-lime-200">Yeble</span>
            ...
            <p className="mt-5 text-base text-lime-50/85">Loading experience…</p>
          </div>
        </div>
      )}
